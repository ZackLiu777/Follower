...
struct Theme: Sendable {
    ...
    static let instagram = Theme(
        ...
        cardSurface: Color.white.opacity(0.85),
        cardElevated: Color(.tertiarySystemGroupedBackground),
    ...
    static let forest = Theme(
        ...
        cardSurface: Color.white.opacity(0.80),
    ...
    static let roseGold = Theme(
        ...
        cardSurface: Color.white.opacity(0.85),
        cardElevated: Color.white.opacity(0.95),
    ...
    static let monoStone = Theme(
        ...
        cardElevated: Color(red: 0.96, green: 0.95, blue: 0.94),
