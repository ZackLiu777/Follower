...
enum L10n {
    ...
    enum Premium {
        ...
        // MARK: 成长里程碑（v1.11）
        static let milestones = "premium.milestones"
        static let milestoneNoData = "premium.milestoneNoData"
        static let milestoneNoDataDesc = "premium.milestoneNoDataDesc"
        static let milestoneSummaryEvents = "premium.milestoneSummaryEvents"
        static let milestoneSummaryViral = "premium.milestoneSummaryViral"
        static let milestoneSummaryBest = "premium.milestoneSummaryBest"
        static let milestoneEventCount = "premium.milestoneEventCount"
        static let milestoneFollower = "premium.milestoneFollower"
        static let milestoneViral = "premium.milestoneViral"
        static let milestoneBest = "premium.milestoneBest"
        static let milestoneUnfollow = "premium.milestoneUnfollow"
        static let milestoneBoostWeek = "premium.milestoneBoostWeek"
        static let milestoneLastEvent = "premium.milestoneLastEvent"
        static let milestoneEngagements = "premium.milestoneEngagements"
        static let milestoneNewFollowers = "premium.milestoneNewFollowers"
        static let milestoneLost = "premium.milestoneLost"
        static let milestoneDays = "premium.milestoneDays"
        static let milestoneToday = "premium.milestoneToday"
